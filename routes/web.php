...
//Dev
Route::get('/admin', 'DashboardController@ViewHome');

Route::get('/admin/login', 'DashboardController@ViewLogin');

Route::post('/admin/login/check', 'DashboardController@Login');

Route::get('/admin/payment', 'DashboardController@ViewPembayaran');

Route::get('/admin/today-transaction', 'DashboardController@ViewTransaksiToday');

Route::get('/admin/tomorrow-transaction', 'DashboardController@ViewTransaksiBesok');

Route::get('/admin/archive', 'DashboardController@ViewArchived');

Route::get('/admin/add', 'DashboardController@ViewAddTransaction');
